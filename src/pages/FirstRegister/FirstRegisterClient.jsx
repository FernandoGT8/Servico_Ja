...
// Primeira etapa do cadastro do Cliente: só cria a conta (login).
// O resto do perfil (segmento, CNPJ, responsável...) é preenchido depois,
// já autenticado, em /register/client/complete (pages/Register/RegisterClient.jsx).
export default function FirstRegisterClient() {
  const { login } = useAuth();
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      login(data);
      setLoading(false);
      navigate("/register/client/complete");
    } catch (err) {
