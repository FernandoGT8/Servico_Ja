...
import { CURSOS, HABILIDADES, STATUS_CONTRATO_FINALIZADOS } from "@/data/catalogos";
...
export default function ContractDetailClient() {
  ...
  // Campos calculados (PRD §4.5) — sempre somente leitura. "Dias de trabalho"
  // também é calculado (intervalo Data de Início → Data de Encerramento,
  // menos os Dias de folga) — o Cliente nunca edita essa lista, nem via
  // "Editar Contrato". Simplificação: descontamos diasFalta do total na
  // hora, mas na regra real (§4.8) a falta só desconta depois que o
  // Prestador aprova a remoção — sem backend, não temos como saber se já
  // foi aprovada.
