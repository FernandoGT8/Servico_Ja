...
import { primaryButtonClassName } from "@/components/ContractForm/contractFormUtils";
...
// Visão de CLIENTE de /contracts — só os próprios contratos (escopo por
// registro, PRD §3.6; o backend filtra pelo dono do token, não há parâmetro
// de cliente aqui), filtráveis por Status e Tipo de contrato (PRD §4.6).
// Endpoint ainda não existe — ver BACKEND_ANALISE.md §6, item 13.
  ...
  return (
    <div className="w-full font-poppins">
      ...
      <ContractsActionBar
        ...
        temMais={temMais}
        extra={
          <Link to="/client/contracts/new" className={primaryButtonClassName}>
            Novo Contrato
          </Link>
        }
      />
